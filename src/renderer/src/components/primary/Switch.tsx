...
const Switch = forwardRef<HTMLInputElement, SwitchProps>((props, ref) => {
  ...
  const trackClasses = cn(
    ...
    isError ? "focus-visible:ring-red-500 peer-checked:bg-red-600" : "focus-visible:ring-indigo-600 peer-checked:bg-indigo-600",
    ...
    <div className="flex flex-col">
      <div className={containerClasses}>
        <div className="relative flex items-center">
          ...
          <div className={trackClasses} onClick={() => !disabled && document.getElementById(inputId)?.click()}>
