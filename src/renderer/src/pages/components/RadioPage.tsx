    ...
    <div className="flex flex-col gap-10 p-10 h-full overflow-y-auto bg-slate-50/50">
      <div className="flex flex-col gap-2">
        ...
        <ZText variant="body" size="lg" color="secondary" className="max-w-2xl">
          The <code className="text-sm font-bold text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded">ZRadio</code> component allows users to select a single option from a list of mutually exclusive options.
        </ZText>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xln:grid-cols-3 gap-8">
        ...
        <ShowcaseSection title="Basic Group">
          <div className="flex flex-col gap-3">
             <ZText variant="label" className="text-slate-500 mb-1">Select a Plan:</ZText>
             <ZRadio 
               name="plan" 
               value="free" 
               label="Free Plan" 
        ...
        <ShowcaseSection title="Horizontal Group" className="md:col-span-2">
           <div className="flex flex-col gap-2">
              <ZText variant="label" className="text-slate-500">Pick a Color:</ZText>
              <div className="flex flex-wrap gap-6 p-4 bg-slate-50 rounded-lg border border-slate-100">
                <ZRadio name="color" value="red" label="Red" checked={selectedColor === "red"} onChange={() => setSelectedColor("red")} />
                <ZRadio name="color" value="blue" label="Blue" checked={selectedColor === "blue"} onChange={() => setSelectedColor("blue")} />
                <ZRadio name="color" value="green" label="Green" checked={selectedColor === "green"} onChange={() => setSelectedColor("green")} />
              </div>
           </div>
        </ShowcaseSection>
