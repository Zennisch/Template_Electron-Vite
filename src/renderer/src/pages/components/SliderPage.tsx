    ...
    <div className="flex flex-col gap-10 p-10 h-full overflow-y-auto bg-slate-50/50">
      <div className="flex flex-col gap-2">
        ...
        <ZText variant="body" size="lg" color="secondary" className="max-w-2xl">
          The <code className="text-sm font-bold text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded">ZSlider</code> component allows users to make selections from a range of values. It supports custom formatting, steps, and validation states.
        </ZText>
      </div>
        ...
        <ShowcaseSection title="States & Validation">
          <div className="flex flex-col gap-6">
            ...
            <ZSlider
              ...
              defaultValue={20}
              helpText="Adjust sensitivity level"
              showValue
              fullWidth
            />
          </div>
