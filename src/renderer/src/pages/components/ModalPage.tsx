    ...
    <div className="flex flex-col gap-10 p-10 h-full overflow-y-auto bg-slate-50/50">
      <div className="flex flex-col gap-2">
        ...
        <ZText variant="body" size="lg" color="secondary" className="max-w-2xl">
          The <code className="text-sm font-bold text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded">ZModal</code> component appears in front of application content to present information or require user interaction.
        </ZText>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xln:grid-cols-3 gap-8">
        ...
        <ShowcaseSection title="Basic Usage">
            ...
            <ZModal
              ...
              footer={
                <div className="flex justify-end gap-2">
                  <ZButton variant="ghost" onClick={() => setBasicOpen(false)}>Cancel</ZButton>
                  <ZButton onClick={() => setBasicOpen(false)}>Confirm</ZButton>
                </div>
              }
            >
              <ZText>
                This is a basic modal example. You can put any content here. Modals are great for focusing user attention on a specific task.
              </ZText>
            </ZModal>
          </div>
        </ShowcaseSection>
         ...
         <ShowcaseSection title="Sizes">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-2">
                <div className="w-40">
                    <ZSelect 
                        options={SIZES} 
                        value={selectedSize} 
                        onChange={(val) => setSelectedSize(val as string)} 
                        fullWidth
                    />
                </div>
            ...
            >
              <ZText>
                This modal is demonstrating the <strong>{selectedSize}</strong> size variant.
                Resize the browser window to see how it adapts to smaller screens.
              </ZText>
            </ZModal>
          </div>
        </ShowcaseSection>
        ...
        <ShowcaseSection title="Scrollable Content">
          <div className="flex flex-col gap-4">
            ...
            <ZButton variant="primary" onClick={() => setScrollOpen(true)}>Open Long Modal</ZButton>
            ...
            <ZModal
              ...
              footer={
                <div className="flex justify-end gap-2">
                  <ZButton variant="ghost" onClick={() => setScrollOpen(false)}>Decline</ZButton>
        ...
        <ShowcaseSection title="Alert State">
          <div className="flex flex-col gap-4">
            ...
            <ZButton color="danger" onClick={() => setAlertOpen(true)}>Delete Account</ZButton>
            ...
            <ZModal
              ...
              footer={
                <div className="flex justify-end gap-2">
                  <ZButton variant="ghost" onClick={() => setAlertOpen(false)}>Cancel</ZButton>
                  <ZButton color="danger" onClick={() => setAlertOpen(false)}>Delete Permanently</ZButton>
                </div>
              }
            >
              <ZText>
            ...
            <ZModal
              ...
              footer={
                <div className="flex justify-between w-full">
                  ...
                  <ZButton onClick={handleNextStep}>
