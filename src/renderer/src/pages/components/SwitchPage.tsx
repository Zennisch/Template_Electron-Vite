    ...
    <div className="flex flex-col gap-10 p-10 h-full overflow-y-auto bg-slate-50/50">
      <div className="flex flex-col gap-2">
        ...
        <ZText variant="body" size="lg" color="secondary" className="max-w-2xl">
          The <code className="text-sm font-bold text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded">ZSwitch</code> component is used to toggle the state of a single setting on or off.
        </ZText>
      </div>
        ...
        <ShowcaseSection title="Controlled State">
          <div className="flex flex-col gap-4">
             ...
             <div className="text-sm">
                Current State: <span className={`font-bold ${isEnabled ? "text-green-600" : "text-slate-500"}`}>{isEnabled ? "ON" : "OFF"}</span>
             </div>
          </div>
        </ShowcaseSection>
